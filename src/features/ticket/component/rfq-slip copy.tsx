      ...
      <div ref={ticketRef}>
        ...
        <div className="bg-black p-4 rounded-3xl">
          <div className="bg-dark-100 p-5 max-sm:px-3 rounded-3xl mb-2">
            <span className="bg-blue-tone-900/10 border h-14 w-14 rounded-full flex items-center justify-center mx-auto mb-4">
              <FGTruckFill
                color={
              ...
              <>
                <div className="flex flex-wrap items-center justify-between mb-3">
                  <Text variant="pxs" color="text-[#FFFFFFB8]">
                    ...
                    {/* {` (${
                      ((userRole === 'transporter'
                        ? serviceFees.transporterServiceFeePercentage
                        : serviceFees.traderServiceFeePercentage) * 100).toFixed(1)
                    }%)`} */}
                  </Text>
                  <Text
                    variant="ps"
